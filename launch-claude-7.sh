#!/bin/bash
# MIGRATED-BY migrate_library.py — slot 7 is now library topic f86707db «CRM, UpWork».
...
# loads cs-f86707db, unloading an idle topic at the limit). No order gate: the
