#!/bin/bash
# MIGRATED-BY migrate_library.py — slot 6 is now library topic 5047247b «app - legal, DESIGN, seo2».
...
# loads cs-5047247b, unloading an idle topic at the limit). No order gate: the
