#!/bin/bash
# MIGRATED-BY migrate_library.py — slot 9 is now library topic dc22914f «Visual».
...
# loads cs-dc22914f, unloading an idle topic at the limit). No order gate: the
# library decides what loads.
SESSION="claude-terminal-9"
AGENT_ID="9"
LIB_ID="dc22914f"
