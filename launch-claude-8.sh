#!/bin/bash
# MIGRATED-BY migrate_library.py — slot 8 is now library topic bef2d270 «getmyboat».
...
# loads cs-bef2d270, unloading an idle topic at the limit). No order gate: the
# library decides what loads.
SESSION="claude-terminal-8"
AGENT_ID="8"
LIB_ID="bef2d270"
