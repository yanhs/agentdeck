#!/bin/bash
# MIGRATED-BY migrate_library.py — slot 2 is now library topic 3beb2a44 «app - PIPE, news, seo, encription, magiclink».
...
# loads cs-3beb2a44, unloading an idle topic at the limit). No order gate: the
